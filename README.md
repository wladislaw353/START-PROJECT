...
<br>Классы <code>.align-left</code> <code>.align-canter</code> <code>.align-right</code> используется для горизонтального выравнивания элементов. Изменить свойства можно в <code>style.scss</code>. Для использования оберните элемент классом.
