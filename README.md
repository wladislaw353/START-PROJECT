...
<br>Классы <code>.align-left</code> <code>.align-canter</code> <code>.align-right</code> используется для горизонтального выравнивания элемента, например кнопки. Изменить свойства можно в <code>style.scss</code>. Для использования оберните элемент классом.
...
<br>Под каждую страну можно добавить свою маску. По умолчанию добавлены маски для Украины и РФ, для остальных страх маска отключается.
