...
# =========== КОНФИГ ===============================================================================
    ...
    $dev_mail = 'wladislaw353@gmail.com';
    ...
    #-🔸-Telegram ----------------------------------------------------------------------------------
        $to_telegram = false;
        $token  = "5455439721:AAGB33vAZ7aLHarSA8C8QES-lDCFYNVrZXk"; // токен телеграм бота, создать в @BotFather
